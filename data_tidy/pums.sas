...
/* The data file "da6497" contains 
 The Census of Populationand Housing, 1990, 
 Public Use Microsample: 1/1000 */

/* The data contains HOUSEHOLD Records and PERSON Records */

/* The records in data file "da6497" look 
 something like this
...
filename pums  'V:\cen1990\008A.001\da6497.gz' ;
...
data temp;
  ...
  infile pums lrecl= 231;
     ...
     input RECTYPE $ 1 @;
      ...
      if RECTYPE='H' then goto HH;
         else if RECTYPE = 'P' then goto PP;
      return;


HH:    retain SERIALNO PERSONS ROOMS BEDROOMS;
...
PP:    retain SERIALNO PERSONS ROOMS BEDROOMS;
