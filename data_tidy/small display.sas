...
*===Display special symbols as axis values using PROC FORMAT with the Graph Template Language (GTL)===*;
proc format;
   value agefmt
...
*===Display special symbols as axis values using PROC FORMAT with PROC SGPLOT===*;
proc format;
   value agefmt
   20-30 = "20 (*ESC*){unicode '2264'x} 30"
   31-40 = "31 (*ESC*){unicode '2264'x} 40"
